...
OutputDir=C:\Github\visio-image\dist
...
[Files]
Source: "C:\Github\visio-image\dist\Arty\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Github\visio-image\dist\Arty\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
